...
def get_all_params(returns, returns2):
    ...
    q1_r = quan(returns2, 1 / 100)
    q5_r = quan(returns2, 5 / 100)
    q99_r = quan(returns2, 99 / 100)
    q95_r = quan(returns2, 95 / 100)
    ...
    return {"mean_on_ret2" : mean_r, "std_on_ret2" : std_r, "q1_on_ret2" : q1_r, "q5_on_ret2" : q5_r, "q95_on_ret2" : q95_r, "q99_on_ret2" : q99_r, "kurtosis_on_ret2" : kurt_r, "skewness_on_ret" : skew_r, "autocorr_on_ret_1" : corr_ret[1], "autocorr_on_ret_5" : corr_ret[5], "autocorr_on_ret_10" : corr_ret[10], "autocorr_on_abs_1" : corr_abs_ret[1], "autocorr_on_abs_5" : corr_abs_ret[5], "autocorr_on_abs_10" : corr_abs_ret[10]}
...
def print_params(params) -> None:
    ...
    core_keys = ['mean_on_ret2', "std_on_ret2", "q1_on_ret2", "q5_on_ret2", "q95_on_ret2", "q99_on_ret2", "kurtosis_on_ret2", "skewness_on_ret", "autocorr_on_ret_1", "autocorr_on_ret_5", "autocorr_on_ret_10", "autocorr_on_abs_1", "autocorr_on_abs_5", "autocorr_on_abs_10"]
    core_rows = []
